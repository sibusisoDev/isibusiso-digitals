...
import growthImg from "@/assets/service-growth.png";
import designImg from "@/assets/service-design.png";

const services = [
    {
        title: "Web Development",
        description: "Full-stack solutions built on modern architectures (React, Node, Next.js). Fast, secure, and scalable from day one.",
        image: devImg,
        features: ["Custom Web Applications", "E-commerce Platforms", "SaaS Dashboards"],
    },
    {
            ...
            <div className="container mx-auto px-6">
                <div className="mb-16 max-w-2xl">
                    ...
                    <p className="text-lg text-muted-foreground">
                        We don't just build websites; we build business assets. Our holistic approach covers every aspect of your digital presence.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <Card key={index} className="bg-card/50 border-white/5 backdrop-blur-sm overflow-hidden group hover:border-primary/50 transition-colors duration-500 rounded-xl border-solid">
